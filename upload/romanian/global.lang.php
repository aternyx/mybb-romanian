...
$l['lastvisit_hidden'] = "(Ascuns)";

$l['search_button'] = 'Caută';
$l['toplinks_memberlist'] = "Listă de Membri";
$l['toplinks_search'] = "Caută";
$l['toplinks_calendar'] = "Calendar";
$l['toplinks_help'] = "Ajutor";
$l['toplinks_portal'] = "Portal";
$l['bottomlinks_forumteam'] = "Echipa Forumului";
$l['bottomlinks_contactus'] = "Contactează-ne";
$l['bottomlinks_returntop'] = "Înapoi sus";
$l['bottomlinks_syndication'] = "Sindicatie RSS";
$l['bottomlinks_litemode'] = "Mod Lite (Archive)";
$l['bottomlinks_markread'] = "Marchează toate forumurile ca citit";

$l['welcome_usercp'] = "User CP";
$l['welcome_modcp'] = "Mod CP";
$l['welcome_admin'] = "Admin CP";
$l['welcome_logout'] = "Delogare";
$l['welcome_login'] = "Logare";
$l['welcome_register'] = "Înregistrare";
$l['welcome_open_buddy_list'] = "Deschideți Lista de Prieteni";
$l['welcome_newposts'] = "Vezi Postări Noi";
$l['welcome_todaysposts'] = "Vezi Postările de Astăzi";
$l['welcome_pms'] = "Mesaje private";
$l['welcome_pms_usage'] = "({1} necitite, {2} în total)";
$l['welcome_back'] = "<strong>Bine ai venit înapoi, {1}</strong>. Ultima dată când ai intrat: {2}";
$l['welcome_guest'] = "Salut, oaspete!";
$l['welcome_current_time'] = "<strong>Ora curentă:</strong> {1}";

$l['moved_prefix'] = "Mutat:";
$l['poll_prefix'] = "Sondaj:";
...
$l['lost_password'] = "Ai pierdut parola?";
$l['remember_me'] = "Ține-mă minte";
